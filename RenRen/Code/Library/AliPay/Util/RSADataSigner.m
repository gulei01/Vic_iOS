...
//    NSString *path = [[array objectAtIndex:0] stringByAppendingPathComponent:@"AlixPay-RSAPrivateKey"];
	
	//
	// 把密钥写入文件
	//
	NSString *formatKey = [self formatPrivateKey:_privateKey];
    if([formatKey writeToFile:path atomically:YES encoding:NSUTF8StringEncoding error:nil]){
