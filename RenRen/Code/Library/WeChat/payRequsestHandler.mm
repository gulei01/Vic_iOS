...
-(NSMutableDictionary *)sendPay:(NSString *)orderNO price:(NSInteger)price{
    //订单标题，展示给用户
    NSString *order_name    = @"外卖郎 订单";
    //订单金额,单位（分）
    NSString *order_price   = [WMHelper integerConvertToString:price];
...
-(NSMutableDictionary *)sendPay:(NSString *)orderNO price:(NSInteger)price noticeUrl:(NSString *)noticeUrl{
    //订单标题，展示给用户
    NSString *order_name    = @"外卖郎 订单";
    //订单金额,单位（分）
    NSString *order_price   = [WMHelper integerConvertToString:price];
...
- (NSString *)getIPAddress
{
   ...
   NSRange range = [address rangeOfString:@"error"];
