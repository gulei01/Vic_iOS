...
@interface HomeHeaerZT()<SDCycleScrollViewDelegate>
...
-(void)layoutUI{
    ...
    self.marqueeLabel.frame = CGRectMake(0, 0, SCREEN_WIDTH, 0.f);
...
-(void)loadNotice:(NSString *)notice{
    if(notice){
        ...
        self.marqueeLabel.frame = CGRectMake(0, 0, SCREEN_WIDTH, 40.f);
