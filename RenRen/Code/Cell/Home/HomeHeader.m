...
-(void)layoutUI{
    ...
    self.middleView = [[UIView alloc]initWithFrame:CGRectMake(0, CGRectGetMaxY(self.txtSearch.frame)+5, SCREEN_WIDTH, 160+180)];
...
-(void)loadNotice:(NSString *)notice{
    if(notice){
        _notice = notice;
        self.middleView.frame = CGRectMake(0, CGRectGetMaxY(self.txtSearch.frame)+5, SCREEN_WIDTH, 200+180);
