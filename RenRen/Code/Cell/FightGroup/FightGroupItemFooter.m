...
@interface FightGroupItemFooter ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation FightGroupItemFooter
...
- (NSAttributedString *)_attributedStringForSnippetUsingiOS6Attributes:(BOOL)useiOS6Attributes
{
    ...
    NSMutableDictionary *options = [NSMutableDictionary dictionaryWithObjectsAndKeys:[NSNumber numberWithFloat:1.0], NSTextSizeMultiplierDocumentOption, [NSValue valueWithCGSize:maxImageSize], DTMaxImageSize,
                                    @"Times New Roman", DTDefaultFontFamily,DTDefaultFontSize,[UIFont systemFontOfSize:18.f],  @"purple", DTDefaultLinkColor, @"red", DTDefaultLinkHighlightColor, callBackBlock, DTWillFlushBlockCallBack, nil];
...
-(void)loadData:(MFightGroup *)entity array:(NSMutableArray*)arry complete:(void (^)(CGSize))complete{
    if(entity){
        _entity = entity;
        self.arrayData = arry;
        ...
        NSString* str =[NSString stringWithFormat:@"已有%@人拼团成功",entity.goodsSales];
...
-(DTAttributedTextView *)contentView{
    if(!_contentView){
        ...
        _contentView.contentInset = UIEdgeInsetsMake(0, 10, 0, 10);
    }
    return _contentView;
}
