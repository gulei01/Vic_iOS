...
//  KYRR
//
//  Created by kuyuZJ on 16/10/28.
//
//

#import "BuyAddressV2.h"
#import "SearchBuyAddress.h"
#import "KCAnnotation.h"
#import "EditAddressMapCell.h"

@interface BuyAddressV2 ()<MAMapViewDelegate,AMapSearchDelegate,UITableViewDelegate,UITableViewDataSource,UISearchBarDelegate,UISearchDisplayDelegate>
...
@property (nonatomic, strong) SearchBuyAddress *resultsTableController;
...
-(SearchBuyAddress *)resultsTableController{
    if(!_resultsTableController){
        _resultsTableController = [[SearchBuyAddress alloc]init];
