...
@interface StoreCommentV2 ()<DZNEmptyDataSetDelegate,DZNEmptyDataSetSource>
...
-(CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if(entity.replyComment){
        replyHeight+=20.f;
        CGFloat emptyReply = [WMHelper calculateTextHeight:entity.replyComment font:[UIFont systemFontOfSize:14.f] width:(SCREEN_WIDTH-30)];
        replyHeight+=emptyReply;
        NSLog( @"%.2f  %@  \n %@",replyHeight,[self class],entity.replyComment);
    }
    return height+empty+replyHeight;
}
