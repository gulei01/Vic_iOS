...
@interface WineList ()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,DZNEmptyDataSetSource,DZNEmptyDataSetDelegate,GoodsCellDelegate>
...
- (void)viewDidLoad {
    ...
    self.cellIdentifer =  @"WineListCell";
...
-(void)viewDidAppear:(BOOL)animated{
    ...
    self.topView.contentSize = CGSizeMake(self.contentWidth, 0.f);
     self.navigationItem.title = @"外卖郎酒库";
}
...
-(void)queryData{
    ...
    NSDictionary* arg = @{@"ince":@"get_food_list",@"zoneid":self.Identity.location.circleID,@"pcate":[WMHelper integerConvertToString:self.categoryID],@"cate":[WMHelper integerConvertToString:self.subCategoryID],@"page":[WMHelper integerConvertToString:self.page.pageIndex]};
...
-(void)querySubCategory{
    NSDictionary* arg = @{@"ince":@"get_cate_pcate",@"zoneid":self.Identity.location.circleID,@"pcate":[WMHelper integerConvertToString:self.categoryID]};
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    WineListCell* cell = (WineListCell*)[collectionView dequeueReusableCellWithReuseIdentifier:self.cellIdentifer forIndexPath:indexPath];
...
- (CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout*)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath *)indexPath{
    return CGSizeMake(SCREEN_WIDTH/2-10, SCREEN_WIDTH/2+60);
}
...
-(void)loadMenu{
    ...
    self.labelLine.frame = CGRectMake(0, 47, (SCREEN_WIDTH/4), 3);
...
-(UICollectionView *)collectionView{
    if(!_collectionView){
        ...
        [_collectionView registerClass:[WineListCell class] forCellWithReuseIdentifier:self.cellIdentifer];
